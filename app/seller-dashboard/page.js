                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      ...
                      className="text-sm bg-gradient-to-r from-orange-500 to-red-500 text-white px-3 py-1 rounded-full hover:shadow-lg transition-all flex items-center space-x-1"
                    >
                      <span>✨</span>
                      <span>Generate</span>
                    </button>
